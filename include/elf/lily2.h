...
START_RELOC_NUMBERS (elf_lily2_reloc_type)
  ...
  RELOC_NUMBER (R_LILY2_32, 1)
  RELOC_NUMBER (R_LILY2_16, 2)
  RELOC_NUMBER (R_LILY2_8, 3)
  RELOC_NUMBER (R_LILY2_CONSTL, 4)
  RELOC_NUMBER (R_LILY2_CONSTH, 5)
  RELOC_NUMBER (R_LILY2_JUMPTARG, 6)
  RELOC_NUMBER (R_LILY2_GNU_VTENTRY, 7)
  RELOC_NUMBER (R_LILY2_GNU_VTINHERIT, 8)
